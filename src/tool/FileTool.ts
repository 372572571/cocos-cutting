...
export function ArrayMd5(data: any) {
    ...
    function rol(num: any, places: any) {
        return ((num << places) & 0xFFFFFFFF) | (num >>> (32 - places));
    }

    // The 4 MD5 functions
    function fF(b: any, c: any, d: any) {
        return (b & c) | (~b & d);
    }

    function fG(b: any, c: any, d: any) {
        return (d & b) | (~d & c);
    }

    function fH(b: any, c: any, d: any) {
        return b ^ c ^ d;
    }

    function fI(b: any, c: any, d: any) {
        return c ^ (b | ~d);
    }

    // pick 4 bytes at specified offset. Little-endian is assumed
    function bytes_to_int32(arr: any, off: any) {
